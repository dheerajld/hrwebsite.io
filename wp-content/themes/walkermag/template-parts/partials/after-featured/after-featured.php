<?php
$section_main_category = get_theme_mod('walkermag_featured_after_main_category');
$walkermag_second_category = get_theme_mod('walkermag_featured_after_sidebar_category');
$walkermag_third_category = get_theme_mod('walkermag_featured_after_sidebar_category_2');
$walkermag_section_heading_one = get_theme_mod('after_featured_main_heading');
$walkermag_section_heading_two = get_theme_mod('after_featured_sidebar_heading');
$walkermag_section_heading_three = get_theme_mod('after_featured_sidebar_heading_2');
$walkermag_section_ads_image_url= get_theme_mod('after_featured_ads_image');
$walkermag_section_ads_image_link= get_theme_mod('after_featured_ads_image_link');
$walkermag_section_sidebar = 'after-feature-sidebar';
$walkermag_section_layout = get_theme_mod('walkermag_after_featured_section');

if(get_theme_mod('featured_after_status')){
