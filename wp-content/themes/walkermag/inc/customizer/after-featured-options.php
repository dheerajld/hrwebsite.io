<?php
/**
*After Featured  customizer options
*
* @package WalkerMag
*
*/
if (! function_exists('walkermag_after_featured_options_register')) {
	function walkermag_after_featured_options_register( $wp_customize ) {
//After Featured
		$wp_customize->add_section('walkermag_featured_after', 
		 	array(
		        'title' => esc_html__('After Featured Section', 'walkermag'),
		        'panel' =>'walkermag_frontpage_option',
		        'priority' => 5,
		        'divider' => 'before',
	    	)
		 );
		$wp_customize->add_setting( 'featured_after_status', 
	    	array(
		      'default'  =>  false,
		...
		$wp_customize->add_control( 'featured_after_status', 
			array(
			  'label'   => esc_html__( 'Enable After Featured Section', 'walkermag' ),
			  'section' => 'walkermag_featured_after',
			  'settings' => 'featured_after_status',
			  'type'    => 'checkbox',
			)
		);
		...
		$wp_customize->add_setting( 
	        'walkermag_after_featured_section', 
	        array(
			...
			new WP_Customize_Control(
				...
				array(
					...
					'active_callback' => function(){
					    return get_theme_mod( 'featured_after_status', true );
					},
				)
			)
		);
		$wp_customize->add_setting( 'after_featured_main_heading', 
		 	array(
		...
		$wp_customize->add_control( 'after_featured_main_heading', 
			array(
				'type' => 'text',
				'section' => 'walkermag_featured_after',
				'label' => esc_html__( 'Section Heading','walkermag' ),
				'description' => esc_html__( 'Heading text for display on recent after featured main content','walkermag' ),
				'active_callback' => function(){
				    return get_theme_mod( 'featured_after_status', true );
				},
			)
		);
		$wp_customize->add_setting('walkermag_featured_after_main_category',
	    array(
	        'default'           => '',
	        'capability'        => 'edit_theme_options',
	        'sanitize_callback' => 'walkermag_sanitize_text',
		...
		$wp_customize->add_control(
			...
			'walkermag_featured_after_main_category',
			    array(
			        ...
			        'taxonomy'    => 'category',
			        'settings'	  => 'walkermag_featured_after_main_category',
			        'priority'    => 10,
				    'active_callback' => function(){
					    return get_theme_mod( 'featured_after_status', true );
					},
		...
		$wp_customize->add_setting( 'after_featured_sidebar_heading', 
		 	array(
				'capability' => 'edit_theme_options',
				'default' => '',
				'sanitize_callback' => 'walkermag_sanitize_text',
		...
		$wp_customize->add_control( 'after_featured_sidebar_heading', 
			array(
				'type' => 'text',
				'section' => 'walkermag_featured_after',
				'label' => esc_html__( 'Sidebar Section Heading','walkermag' ),
				'description' => '',
				'active_callback' => 'walkermag_double_category_check',
			)
		);
		$wp_customize->add_setting('walkermag_featured_after_sidebar_category',
	    array(
	        'default'           => '',
	        'capability'        => 'edit_theme_options',
	        'sanitize_callback' => 'walkermag_sanitize_text',
		...
		$wp_customize->add_control(
			new WalkerMag_Dropdown_Taxonomies_Control($wp_customize, 
			'walkermag_featured_after_sidebar_category',
			    array(
			        ...
			        'type'        => 'dropdown-taxonomies',
			        'taxonomy'    => 'category',
			        'settings'	  => 'walkermag_featured_after_sidebar_category',
			        'priority'    => 10,
				    'active_callback' => 'walkermag_double_category_check',
		...
		$wp_customize->add_setting( 'after_featured_sidebar_heading_2', 
		 	array(
				'capability' => 'edit_theme_options',
				'default' => '',
				'sanitize_callback' => 'walkermag_sanitize_text',
		...
		$wp_customize->add_control( 'after_featured_sidebar_heading_2', 
			array(
				'type' => 'text',
				'section' => 'walkermag_featured_after',
				'label' => esc_html__( 'Sidebar Section Heading 2','walkermag' ),
				'description' => '',
				'active_callback' => 'walkermag_third_category_check',
			)
		);
		$wp_customize->add_setting('walkermag_featured_after_sidebar_category_2',
	    array(
	        'default'           => '',
	        'capability'        => 'edit_theme_options',
	        'sanitize_callback' => 'walkermag_sanitize_text',
		...
		$wp_customize->add_control(
			new WalkerMag_Dropdown_Taxonomies_Control($wp_customize, 
			'walkermag_featured_after_sidebar_category_2',
			    array(
			        ...
			        'type'        => 'dropdown-taxonomies',
			        'taxonomy'    => 'category',
			        'settings'	  => 'walkermag_featured_after_sidebar_category_2',
			        'priority'    => 10,
				    'active_callback' => 'walkermag_third_category_check',
		...
		if(walkermag_set_to_premium()){
			$wp_customize->add_setting('after_featured_ads_image', array(
		        'transport'         => 'refresh',
		        'sanitize_callback'     =>  'walkermag_sanitize_file',
		    ));

		    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'after_featured_ads_image', array(
		        'label'             => esc_html__('Upload Image', 'walkermag'),
		        'description'       => esc_html__('Advertisement Image for after featured section', 'walkermag'),
		        'section'           => 'walkermag_featured_after',
		        'settings'          => 'after_featured_ads_image',
		        'active_callback' => function(){
				    return get_theme_mod( 'featured_after_status', true );
				},
		    )));
		    $wp_customize->add_setting( 'after_featured_ads_image_link',
	          array(
	            'default'        => '',
	            'sanitize_callback' => 'walkermag_sanitize_url'
	          ) 
	        );
	        $wp_customize->add_control( 'after_featured_ads_image_link', 
	            array(
	              'label'   => esc_html__( 'Advertisement Link', 'walkermag' ),
	              'section' => 'walkermag_featured_after',
	              'settings'   => 'after_featured_ads_image_link',
	              'type'     => 'text',
	              'active_callback' => function(){
				    return get_theme_mod( 'featured_after_status', true );
				},
	...
	function walkermag_third_category_check(){
		$walkermag_section_status = get_theme_mod( 'featured_after_status');
        $section_chhoice_type= get_theme_mod( 'walkermag_after_featured_section' );
    ...
    function walkermag_double_category_check(){
		$walkermag_section_status = get_theme_mod( 'featured_after_status');
        $section_chhoice_type= get_theme_mod( 'walkermag_after_featured_section' );
...
add_action( 'customize_register', 'walkermag_after_featured_options_register' );